...
def payroll_pdf(worker, summary, year, month, title="Prospetto paga di supporto"):
    ...
    rows = [
        ...
        ["Anticipi lavoratrice da rimborsare", f"€ {summary.get('worker_advances', '0.00')}"],
        ["Anticipi datore da recuperare", f"€ {summary.get('employer_advances', '0.00')}"],
        ["Rettifica netta spese/anticipi", f"€ {summary['reimbursements']}"],
